...
public:
   ...
   ****************************************************************************/
   getStdDeviation(State& state, int* hashMap)
   {
...
public:
   ...
   ****************************************************************************/
   State simulate()
   {
      ...
      {
         currentEnergy = currentHash.getStdDeviation(currentState, hashTable);
      }
   ...
   ****************************************************************************/
   int anneal(int runLimit, int alterationLimit)
   {
      ...
      for (int i = 0; i <= runLimit; i++)
      {
         ...
         {
            int newEnergy = currentHash.getStdDeviation(alteration, hashTable);
         }
...
int main(int argc, char* argv[])
{
   ...
   switch (menuPrompt())
   {
      ...
      case 2:
         ...
         cout << "BASE (x=9, y=14, z=4, w=10): "
              << commonHash->getStdDeviation(baseState, hashTable)
              << endl << endl;
         break;
      case 3:
         //Exit;
